...
export const blankCookies = () => {
    return [getCookie('refresh_token', null, null), getCookie('access_token', null, null), getCookie('expires_at', null, null)];
};
...
export async function refreshAccessToken(cookies) {
    ...
    console.log('>>> refreshAccessToken.setAuth.user = ', auth.user());
