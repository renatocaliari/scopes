...
import type { Token, UserResponse } from '$lib/interfaces/userInterface';
import type { CustomError } from '$lib/interfaces/errorInterface';
import { notificationData } from '$lib/stores/notificationStore';
import { userData } from '$lib/stores/userStore';
import { formatText } from '$lib/utils/stringUtils';
...
export async function ProtectedPage(session, nextUrl) {
	if (!session.user) {
		...
		console.log('session.nextUrl:', session.nextUrl);
