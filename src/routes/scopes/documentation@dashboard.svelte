<script>
	...
	// $storeScopesDocumentation = mergeSort(mergeScopesForDocumentation, copyFilteredStore).map(
	// 	(s, idx) => {
	...
	$: {
		if ($storeScopesDocumentation && !moving) {
	...
	function handleDndConsider(e) {
		$storeScopesDocumentation = e.detail.items;
		reordered = true;
		moving = true;
	}
...
<NavigationScopes stepId="documentation" {checkList}>
	<div slot="buttons">
		<label
			for="modal-export"
